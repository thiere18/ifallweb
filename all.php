...
<div class="row container">
   ...
   <div class="col-md-4 ImmageStyle  mb-2  " style="width: 18rem; height:auto;">
    <div class="card">
      <div class="card-block">
      <img class="card-img-top" src="./uploads/<?= $photo->url;?>" alt="Card image cap">
        <div class="car-title">
          <?= $photo->description?>
                    ...
                    <ul class="pagination">
                        ...
                        <?php for($page = 1; $page <= $pages; $page++): ?>
                            <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="./all.php?page=<?= $page ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                        <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="./all.php?page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                        </li>
                    </ul>
                </nav>
</div>
